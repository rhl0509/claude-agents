...
|---|---|---|---|---|---|---|
| 1 | `code-reviewer` | `/review` `/리뷰` | 1.13 | opus | 코드 품질·가독성·버그 리뷰(증상 없는 정적 탐색 · 타 스택 폴백) | Read, Grep, Glob, Bash |
