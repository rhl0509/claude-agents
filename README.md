...
| 7 | `ui-ux-reviewer` | `/ui` | 디자인 | 1.1 | UI/UX·접근성·반응형 점검 | Read, Grep, Glob |
| 8 | `design-system-architect` | `/dsystem` | 디자인 | 1.1 | 디자인 토큰·컴포넌트 설계 | Read, Grep, Glob, Context7 |
| 9 | `data-modeler` | `/datamodel` | 설계 | 1.1 | 데이터 모델/스키마 설계 | Read, Grep, Glob |
| 10 | `system-architect` | `/arch` | 설계 | 1.1 | 시스템 아키텍처 설계 | Read, Grep, Glob, Context7 |
...
<details>
<summary><b>6. migration-reviewer</b> (<code>/migrate</code>) — 마이그레이션 안전성 점검</summary>
...
<details>
<summary><b>7. ui-ux-reviewer</b> (<code>/ui</code>) — UI/UX·접근성 점검</summary>
...
<details>
<summary><b>8. design-system-architect</b> (<code>/dsystem</code>) — 디자인 시스템 설계</summary>
...
<details>
<summary><b>9. data-modeler</b> (<code>/datamodel</code>) — 데이터 모델 설계</summary>
...
<details>
<summary><b>10. system-architect</b> (<code>/arch</code>) — 시스템 아키텍처 설계</summary>
...
- 이 README의 [에이전트 표](#에이전트-10종) 버전 칸도 버전업 시 함께 갱신됩니다.
